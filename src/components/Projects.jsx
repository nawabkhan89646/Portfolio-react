                    ...
                    <div className="flex items-center gap-10 bg-[#A8C090] py-10 px-12 rounded-[2.5rem]" data-aos="zoom-in" data-aos-duration="1500">
                        ...
                        <div className="flex flex-col gap-5 w-full">
                            ...
                            <div className="flex items-center gap-2">
                                <a href="https://github.com/nawabkhan89646/u-matter-project-js.git" target='_blank' className="bg-white p-2 rounded-lg font-semibold text-[#006837] hover:shadow-lg github-repo"><i className="fa-brands fa-github"></i> Github</a>
                                <a className="text-white" target='_blank' href="https://nawabkhan89646.github.io/u-matter-project-js/">Click here to visit the live project!</a>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center gap-10 bg-[#A8C090] py-10 px-12 rounded-[2.5rem]" data-aos="zoom-in" data-aos-duration="1500">
                        ...
                        <div className="flex flex-col gap-5 w-full">
                            ...
                            <div className="flex items-center gap-2">
                                <a href="https://github.com/nawabkhan89646/crypto-project-js.git" target='_blank' className="bg-white p-2 rounded-lg font-semibold text-[#006837] hover:shadow-lg github-repo"><i className="fa-brands fa-github"></i> Github</a>
                                <a className="text-white" target='_blank' href="https://nawabkhan89646.github.io/crypto-project-js/">Click here to visit the live project!</a>
                            </div>
                        </div>
                    </div>
                    {/* <div className="flex items-center gap-10 bg-[#A8C090] py-10 px-12 rounded-[2.5rem]" data-aos="zoom-in" data-aos-duration="1500">
